...
Open in IntelliJ - which should spot that it has a Gradle build file.

Two "tests" are included:

- `GildedRoseTest` - which is a placeholder for writing unit tests.
- `ApprovalTest` - which is a placeholder for writing approval tests.

Your mission is:
- Add enough tests that you are happy to refactor this code
  - It might help to view the test coverage and mutation testing reports - execute `./build.sh` to see them
- Follow the instructions in [GildedRoseRequirements.txt](https://github.com/ivanmoore/gildedrose/blob/master/GildedRoseRequirements.txt)

*****

# BACKGROUND ONLY BELOW HERE - no need to read for the lab

This text is preserved from the originally forked repository. It mentions "[TextTest](http://texttest.org)". For this lab, this has been replaced by "[OkeyDoke](https://github.com/dmcg/okey-doke)".
